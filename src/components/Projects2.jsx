    ...
    for(let i = 0; i < props.c.length;i++){
        ...
        return (
            <div className='projects'>
                ...
                <div className="row">
                    <Project name= {starsCountKey[0]} stars={starsCountValue[0]} lang = {langs[0]} desc={descs[0]}/>
                    <Project name= {starsCountKey[1]}  stars={starsCountValue[1]} lang = {langs[1]} desc={descs[1]}/>
                </div>
                <div className="row">
                    <Project  name= {starsCountKey[2]} stars={starsCountValue[2]} lang = {langs[2]} desc={descs[2]}/>
                    <Project name= {starsCountKey[3]} stars={starsCountValue[3]} lang = {langs[3]} desc={descs[3]}/>
                </div>
                <div className="row">
                    <Project name= {starsCountKey[4]} stars={starsCountValue[4]} lang = {langs[4]} desc={descs[4]}/>
                    <Project name= {starsCountKey[5]} stars={starsCountValue[5]} lang = {langs[5]} desc={descs[5]}/>
                </div>
                <div className="row">
                    <Project name= {starsCountKey[6]} stars={starsCountValue[6]} lang = {langs[6]} desc={descs[6]}/>
                    <Project name= {starsCountKey[7]} stars={starsCountValue[7]} lang = {langs[7]} desc={descs[7]}/>
                </div>
            </div>
        )
}
